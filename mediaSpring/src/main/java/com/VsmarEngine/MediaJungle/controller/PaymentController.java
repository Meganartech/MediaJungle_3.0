...
import com.VsmarEngine.MediaJungle.repository.PaymentRepository;
...
import com.VsmarEngine.MediaJungle.userregister.UserRegisterRepository;
            ...
            if (userOption.isPresent()) {
                ...
                if (optionPayment.isPresent()) {
                    ...
                    if (paym.getExpiryDate().isAfter(LocalDate.now())) {
                        ...
                        return new ResponseEntity<>("You have already paid for the plan. Your subscription is valid until " + paym.getExpiryDate(),HttpStatus.OK);
        	 ...
        	 return new ResponseEntity<>("Invalid data format", HttpStatus.NOT_FOUND);
