...
//                                 backgroundColor: snapshot.isDragging ? 'skyblue' : 'white',
//                               }}
...
//                               </td>
//                               <td className="col-lg-1">
//                                 {/* Only this button acts as the drag handle */}
//                                 <button
//                                   className="btn btn-primary d-flex align-items-center"
//                                   {...provided.dragHandleProps}
//                                 >
//                                   {snapshot.isDragging && (
//                                     <i className="bi bi-arrows-move me-2"></i> // Drag icon appears only when dragging
//                                   )}
//                                   :
//                                 </button>
//                               </td>
