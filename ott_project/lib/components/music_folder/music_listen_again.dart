...
class MusicListenAgain {
  ...
  factory MusicListenAgain.fromJson(Map<String, dynamic> json) =>
      MusicListenAgain(
          songId: json['songId'],
...
class MusicListenAgainSection extends StatefulWidget {
  final List<Music> allAudios;
  final Function(Music) onAudioTap;
  final List<Music> categoryPlayList;

  const MusicListenAgainSection({
    super.key,
  ...
  @override
  _MusicListenAgainSectionState createState() =>
      _MusicListenAgainSectionState();
}

class _MusicListenAgainSectionState extends State<MusicListenAgainSection> {
  Map<int, MusicListenAgain> listenAgainMap = {};
  ...
  List<Music> getListenAgainSongs({int limit = 6}) {
    List<Music> listenAgainSongs = [];
  ...
  Widget build(BuildContext context) {
    List<Music> listenAgainSongs = getListenAgainSongs();
    print(
