...
class _VideoPageState extends State<VideoPage> {
  ...
  void didChangeDependencies() {
    ...
    _allMovies = MovieService.fetchMovies();
    _fetchMovies();
  }
  ...
  void _categorizeMovies(List<Movie> movies) {
    _categorizedMovies.clear();
    for (var movie in movies) {
      if (!_categorizedMovies.containsKey(movie.category)) {
        _categorizedMovies[movie.category] = [];
      }
      _categorizedMovies[movie.category]!.add(movie);
    }
